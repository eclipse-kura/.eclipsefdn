...
orgs.newOrg('iot.kura', 'eclipse-kura') {
  ...
  _repositories+:: [
    ...
    newKuraAddonRepo('kura-log-filesystem', 'Eclipse Kura™ Filesystem log addon', ruleset_disable=false),
    newKuraAddonRepo('kura-management-ui', 'Eclipse Kura™ Web UI'),
    newKuraAddonRepo('kura-metapackage', 'Eclipse Kura™ Metapackage'),
    newKuraAddonRepo('kura-modbus', 'Eclipse Kura™ Modbus addon', ruleset_disable=false),
    ...
    newKuraAddonRepo('kura-s7', 'Eclipse Kura™ S7 addon', ruleset_disable=false),
